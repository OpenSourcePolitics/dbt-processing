...
proposals AS (
    SELECT
        ...
        COALESCE(categorizations.categories[0], 'Sans catégorie') AS first_category,
        categorizations.sub_categories,
        COALESCE(categorizations.sub_categories[0], 'Sans sous-catégorie') AS first_sub_category,
