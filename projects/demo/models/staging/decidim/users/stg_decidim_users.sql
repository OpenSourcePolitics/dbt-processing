...
renamed AS (
    SELECT 
        ...
        COALESCE(extended_data::jsonb->'half_signup'->>'phone_number', phone_number) AS half_signup_phone_number,
        NULLIF(extended_data::jsonb->'half_signup'->>'phone_country', '') AS half_signup_phone_country,
        extended_data
    FROM source
)
SELECT * FROM renamed
