...
JOIN {{ ref('stg_decidim_forms_question_matrix_rows') }} decidim_forms_question_matrix_rows
    ON decidim_forms_question_matrix_rows.id = decidim_forms_answer_choices.decidim_question_matrix_row_id
