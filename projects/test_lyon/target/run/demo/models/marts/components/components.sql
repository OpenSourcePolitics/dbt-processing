  ...
  create  table "test_lyon"."prod"."components__dbt_tmp"
...
WITH assemblies_spaces AS (
    ...
    FROM "test_lyon"."prod"."stg_decidim_assemblies"
),
participatory_processes_spaces AS (
    ...
    FROM "test_lyon"."prod"."stg_decidim_participatory_processes"
), 
...
components AS (
    ...
    FROM "test_lyon"."prod"."int_components" AS decidim_components
    ...
    JOIN "test_lyon"."prod"."int_organizations" AS decidim_organizations ON decidim_organizations.id = participatory_spaces.decidim_organization_id
