  ...
  create  table "test_lyon"."prod"."forms__dbt_tmp"
...
WITH forms_meetings AS (
    ...
    FROM "test_lyon"."prod"."stg_decidim_forms_questionnaires" decidim_forms_questionnaires
    JOIN "test_lyon"."prod"."stg_decidim_meetings" decidim_meetings_meetings ON decidim_meetings_meetings.id = decidim_forms_questionnaires.questionnaire_for_id
    ...
    JOIN "test_lyon"."prod"."stg_decidim_surveys" decidim_surveys_surveys ON decidim_surveys_surveys.id = questionnaire_for_id
...
FROM forms
JOIN "test_lyon"."prod"."components" decidim_components ON decidim_components.id = forms.decidim_component_id
  );
