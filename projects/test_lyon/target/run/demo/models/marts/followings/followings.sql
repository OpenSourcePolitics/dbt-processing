  ...
  create  table "test_lyon"."prod"."followings__dbt_tmp"
...
WITH followings_proposals AS (
    ...
    FROM "test_lyon"."prod"."stg_decidim_follows" AS decidim_follows
    JOIN "test_lyon"."prod"."proposals" decidim_proposals_proposals
    ...
    FROM "test_lyon"."prod"."stg_decidim_follows" AS decidim_follows
    JOIN "test_lyon"."prod"."components" decidim_components
    ...
    SELECT
        ...
        title AS followable_title
    FROM "test_lyon"."prod"."stg_decidim_follows" AS decidim_follows
        JOIN "test_lyon"."prod"."debates" decidim_debates_debates ON decidim_debates_debates.id = decidim_followable_id
    ...
    SELECT
        ...
        title AS followable_title
    FROM "test_lyon"."prod"."stg_decidim_follows" AS decidim_follows
        JOIN "test_lyon"."prod"."blogs_posts" decidim_blogs_posts
    ...
    SELECT
        ...
        '' AS followable_title
    FROM "test_lyon"."prod"."stg_decidim_follows" AS decidim_follows
        JOIN "test_lyon"."prod"."int_users" decidim_users
    ...
    SELECT
        ...
        title AS followable_title
    FROM "test_lyon"."prod"."stg_decidim_follows" AS decidim_follows
        JOIN "test_lyon"."prod"."meetings" decidim_meetings
    ...
    SELECT
        ...
        title AS followable_title
    FROM "test_lyon"."prod"."stg_decidim_follows" AS decidim_follows
        join "test_lyon"."prod"."budgets_projects" decidim_budgets_projects
    ...
    where followable_meta_type != 'Ancestor'
        ...
        FROM real_follow
            join "test_lyon"."prod"."components" AS components ON components.id = real_follow.decidim_component_id
