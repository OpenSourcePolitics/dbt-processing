  ...
  create  table "test_lyon"."prod"."endorsements__dbt_tmp"
...
WITH endorsements_proposals AS (
    ...
    FROM "test_lyon"."prod"."stg_decidim_endorsements" AS decidim_endorsements
        JOIN "test_lyon"."prod"."stg_decidim_proposals" decidim_proposals_proposals on decidim_endorsements.resource_id = decidim_proposals_proposals.id
    ...
    SELECT
        ...
        decidim_component_id
    FROM "test_lyon"."prod"."stg_decidim_endorsements" AS decidim_endorsements
        JOIN "test_lyon"."prod"."stg_decidim_debates" AS decidim_debates_debates on decidim_endorsements.resource_id = decidim_debates_debates.id
    ...
    SELECT
        ...
        decidim_component_id
    FROM "test_lyon"."prod"."stg_decidim_endorsements" AS decidim_endorsements
        JOIN "test_lyon"."prod"."stg_decidim_blogs_posts" AS decidim_blogs_posts on decidim_endorsements.resource_id = decidim_blogs_posts.id
