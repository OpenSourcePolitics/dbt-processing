  ...
  create  table "test_lyon"."prod"."proposals__dbt_tmp"
...
WITH coauthorships AS (
    ...
    JOIN "test_lyon"."prod"."stg_decidim_coauthorships" AS decidim_coauthorships on decidim_users.id = decidim_coauthorships.decidim_author_id
...
votes AS (
    ...
    FROM "test_lyon"."prod"."stg_decidim_proposals_votes"
...
proposals AS (
    ...
    FROM "test_lyon"."prod"."int_proposals" AS decidim_proposals
    ...
    LEFT JOIN "test_lyon"."prod"."int_scopes" AS decidim_scopes ON decidim_scopes.id = decidim_proposals.decidim_scope_id
