  ...
  create  table "test_lyon"."prod"."users__dbt_tmp"
  ...
  (
    ...
    FROM "test_lyon"."prod"."endorsements"
...
forms_answers AS (
    ...
    FROM "test_lyon"."prod"."forms_answers"
...
proposal_votes AS (
    ...
    FROM "test_lyon"."prod"."proposals_votes"
    GROUP BY decidim_author_id
),
...
project_votes AS (
    ...
    FROM "test_lyon"."prod"."projects_votes"
    GROUP BY decidim_user_id
),
...
participations_proposals AS (
    ...
    JOIN "test_lyon"."prod"."stg_decidim_coauthorships" AS decidim_coauthorships
...
followings AS (
    ...
    FROM "test_lyon"."prod"."followings"
)
...
FROM "test_lyon"."prod"."int_users" AS decidim_users
...
JOIN "test_lyon"."prod"."int_organizations" AS decidim_organizations
