  ...
  create  table "test_lyon"."prod"."participations__dbt_tmp"
  ...
  (
    WITH participations_proposals AS (
            ...
            FROM "test_lyon"."prod"."proposals" AS decidim_proposals_proposals
            ...
            FROM "test_lyon"."prod"."endorsements" as decidim_endorsements
            ...
            FROM "test_lyon"."prod"."comments" decidim_comments_comments
            ...
            FROM "test_lyon"."prod"."proposals_votes" as decidim_proposals_proposal_votes
                ...
                JOIN "test_lyon"."prod"."proposals" as decidim_proposals_proposals on decidim_proposals_proposal_votes.decidim_proposal_id = decidim_proposals_proposals.id
            ...
            FROM "test_lyon"."prod"."forms_answers" as decidim_forms_answers
            ...
            FROM "test_lyon"."prod"."debates" decidim_debates_debates
            ...
            FROM "test_lyon"."prod"."meetings" decidim_meetings_meetings
