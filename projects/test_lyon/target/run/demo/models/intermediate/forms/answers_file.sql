  ...
  create  table "test_lyon"."prod"."answers_file__dbt_tmp"
...
WITH org AS (
    ...
    SELECT host
    FROM "test_lyon"."prod"."organizations"
    LIMIT 1
)
SELECT DISTINCT
...
JOIN "test_lyon"."prod"."stg_decidim_attachments" decidim_attachments ON decidim_attachments.attached_to_id = decidim_forms_answers.id
CROSS JOIN org
